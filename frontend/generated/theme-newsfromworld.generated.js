...
import stylesCss from 'themes/newsfromworld/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/newsfromworld/components/vaadin-button.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_newsfromworld_componentCss']) {
    registerStyles(
      'vaadin-button',
      unsafeCSS(vaadinButtonCss.toString())
    );
    
    document['_vaadintheme_newsfromworld_componentCss'] = true;
  }
